...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getRequestHost, getRequestProtocol, setHeader, getHeader, getQuery as getQuery$1, createError, getResponseStatus, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file://D:/prj/site/h3huan.github.io/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/prj/site/h3huan.github.io/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/prj/site/h3huan.github.io/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file://D:/prj/site/h3huan.github.io/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/prj/site/h3huan.github.io/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://D:/prj/site/h3huan.github.io/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://D:/prj/site/h3huan.github.io/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://D:/prj/site/h3huan.github.io/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/prj/site/h3huan.github.io/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/prj/site/h3huan.github.io/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://D:/prj/site/h3huan.github.io/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://D:/prj/site/h3huan.github.io/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/prj/site/h3huan.github.io/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://D:/prj/site/h3huan.github.io/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/prj/site/h3huan.github.io/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/prj/site/h3huan.github.io/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/prj/site/h3huan.github.io/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/prj/site/h3huan.github.io/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://D:/prj/site/h3huan.github.io/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/prj/site/h3huan.github.io/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file://D:/prj/site/h3huan.github.io/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/prj/site/h3huan.github.io/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/prj/site/h3huan.github.io/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/prj/site/h3huan.github.io/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/prj/site/h3huan.github.io/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/prj/site/h3huan.github.io/node_modules/errx/dist/index.js';
import devalue from 'file://D:/prj/site/h3huan.github.io/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { walkResolver } from 'file://D:/prj/site/h3huan.github.io/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/prj/site/h3huan.github.io/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/prj/site/h3huan.github.io","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/prj/site/h3huan.github.io/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/prj/site/h3huan.github.io/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/prj/site/h3huan.github.io/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/prj/site/h3huan.github.io/.data/kv"}));
...
const _h6iXYmc7JOJDMSrwf4Vu5px1gVP2Qu90GaCI71CZ5c = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/prj/site/h3huan.github.io";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"google-site-verification","content":"pmvDj44iSfn-8rbSAyNAo9sXYd1nEJquRW-ptRoRbvc"}],"link":[],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","titleTemplate":"%s - Toool","title":"施工中"};
...
const _klNGCOdX1H6Dqh7yeEzvKeohHvp5KCjWUgOPA0Q2CYs = (nitroApp) => {
...
const _R4LRHCwqMS_NKxxko5YTONN9oEPDBcfcmVGAFtjI7HU = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _h6iXYmc7JOJDMSrwf4Vu5px1gVP2Qu90GaCI71CZ5c,
_klNGCOdX1H6Dqh7yeEzvKeohHvp5KCjWUgOPA0Q2CYs,
_R4LRHCwqMS_NKxxko5YTONN9oEPDBcfcmVGAFtjI7HU
];
...
const _j0MA67 = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _sPL8aZ = eventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file://D:/prj/site/h3huan.github.io/node_modules/fast-xml-parser/src/fxp.js');
...
const _J64jrV = defineEventHandler(async (e) => {
...
const _CVX2_3 = defineEventHandler(async (e) => {
...
const _wKsNSu = defineEventHandler(async (e) => {
...
const _8o4BQ6 = defineEventHandler(async (e) => {
...
const _5i5zlD = defineEventHandler((e) => {
...
const getServerEntry = () => import('file://D:/prj/site/h3huan.github.io/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://D:/prj/site/h3huan.github.io/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_wTuEor = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_wTuEor, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _j0MA67, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _sPL8aZ, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _J64jrV, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _CVX2_3, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _wKsNSu, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _8o4BQ6, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _5i5zlD, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wTuEor, lazy: true, middleware: false, method: undefined }
];
