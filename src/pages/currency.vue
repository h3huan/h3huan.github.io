...
useSeoMeta({
  title: "汇率换算 - 实时汇率计算器/美元日元欧元兑人民币 - Toool",
  ogTitle: "汇率换算 - 实时汇率计算器/美元日元欧元兑人民币 - Toool",
  description:
    "实时汇率在线换算，支持人民币、美元、欧元、英镑、日元、港元等 20+ 主要货币，数据每日更新。适合海淘比价、出境换汇、跨境转账估算，汇率仅供参考。",
  ogDescription:
    "实时汇率在线换算，支持人民币、美元、欧元、英镑、日元、港元等 20+ 主要货币，数据每日更新。适合海淘比价、出境换汇、跨境转账估算，汇率仅供参考。",
  keywords: "汇率换算,汇率计算器,实时汇率,货币换算,美元兑人民币,日元汇率,外汇换算",
});
